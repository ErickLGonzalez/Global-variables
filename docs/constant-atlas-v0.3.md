# Observational Decompilation of Physics — Constant Atlas & Restraint Program v0.3
...
**Changelog:** see §9. First blank filled: gravity Composition column ?₃ → **P (H-track)** via B4 REAL certificate (edit-001).
...
## 1. Constant Atlas v0.3 — dependency classes
...
| G (gravity) | **H** (diffeo) | P → **?₂** (GSL) | — | **H** | **P** (H-track; area theorem = composition law) | **?₄** (asympt. safety?) | P (Euler/GHY terms) | **H** (S=A/4ℓ_P²) |
